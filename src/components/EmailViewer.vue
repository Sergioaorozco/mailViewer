...
<template>
    ...
    <div class="flex">
      <article class="w-1/3">
        ...
        <ul class="rounded-lg overflow-clip border border-zinc-300">
          ...
          <li
            ...
            class="bg-zinc-100 hover:bg-zinc-300 px-3 py-2 border-b border-zinc-300 last:border-none"
          >
            {{ email.subject }}
          </li>
        </ul>
      ...
      <article class="p-5 w-2/3 rounded-lg overflow-clip">
        <div class="border border-zinc-200 rounded-lg p-4 mb-4 bg-zinc-100" v-if="selectedEmail.subject">
